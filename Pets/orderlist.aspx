<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="orderlist.aspx.cs" Inherits="Pets.orderlist" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 mt-30 mt-lg-0">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:sqldatasource %>" SelectCommand="SELECT * FROM [Orders]"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </div>
