<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="CatAccessories.aspx.cs" Inherits="Pets.CatAccessories" %>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12 mt-30 mt-lg-0">
                    ...
                    <asp:DataList ID="DataList1" runat="server" DataKeyField="id" CssClass="table" DataSourceID="SqlDataSource1" OnItemCommand="DataList1_OnItemCommand" RepeatColumns="3" RepeatDirection="Horizontal">
                        <ItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=35.237.174.166;Initial Catalog=Ecommerce;User ID=sa;Password=Maya@123" ProviderName="System.Data.SqlClient" SelectCommand="SELECT * FROM [addproduct] WHERE (([category] = @category) AND ([subcategory] = @subcategory))">
                        <SelectParameters>
                            ...
                            <asp:Parameter DefaultValue="Cat Accessories" Name="subcategory" Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                </div>
                    </div>
