<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="register.aspx.cs" Inherits="Pets.register1" %>
                                    ...
                                    <div class="single-input">
                                        ...
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                ...
                                                <asp:TextBox runat="server" ID="txtemail" OnTextChanged="txtemail_OnTextChanged" AutoPostBack="True" Style="border-color: #0B88EE" placeholder="Enter Email" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </div>
                                    <div class="single-input">
                                        <label for="register-form-password">Password</label>
                                        <asp:TextBox runat="server" ID="txtpassword" Style="border-color: #0B88EE" TextMode="Password" placeholder="Enter Password" />
                                    </div>
                                    <div class="single-input">
                                        <asp:Button Text="Sign Up" CssClass="ho-button" runat="server" Style="border-radius: 8px; width: 21%; background-color: #0B88EE; color: #ffffff" OnClick="OnClick" />
                                    </div>
                                </div>
                            </div>
                        </div>
